...
const AlertsCard: React.FC<AlertsCardProps> = ({ isLive, channelId }) => {
  ...
  return (
    <div className="bg-[var(--card-bg)] rounded-xl shadow-lg border border-[var(--border-color)] flex flex-col overflow-hidden flex-1 min-w-[350px]">
      <div className="p-3 border-b border-[var(--border-color)] flex justify-between items-center">
        ...
        <button onClick={() => setAlertsActive(!alertsActive)} className="px-2 py-0.5 rounded text-xs bg-[var(--btn-secondary-bg)] hover:bg-[var(--btn-secondary-hover)] transition">
